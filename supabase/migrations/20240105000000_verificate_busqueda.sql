-- ─── buscar_miembro_publico (v2 — Verificate) ────────────────────────────────
-- Búsqueda por tokens: divide el texto en palabras y exige que TODAS aparezcan
-- en el nombre, en cualquier orden.  Ej: "Victor Ogando" encuentra
-- "Victor Emilio Ogando" porque ambos tokens hacen match.
