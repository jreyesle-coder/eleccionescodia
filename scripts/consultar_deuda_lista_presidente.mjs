/**
 * Consulta la deuda REAL en codiaenlinea.com para el listado de códigos del
 * presidente y guarda el monto_deuda en Supabase.
 *
 ...
 *
 * Uso:
 *   node scripts/consultar_deuda_lista_presidente.mjs
 *
 * Requiere Node >= 18 (fetch nativo). Lee credenciales de .env.local.
 * Requiere la función get_pares_para_deuda y set_deuda_lookup en Supabase.
 * Luego correr el query de reporte para generar la data actualizada.
 */

import { readFileSync } from 'fs'
import { createClient } from '@supabase/supabase-js'

// ── Lista de códigos del presidente (sin duplicados) ──────────────────────────
...
// ── Helpers de consulta (mismo método probado que actualizar_deuda_reporte.mjs) ─
