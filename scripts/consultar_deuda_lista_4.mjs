/**
 * PASO 2 — Consulta la deuda REAL en codiaenlinea.com para la lista 4
 ...
 *   node scripts/consultar_deuda_lista_4.mjs
 *
...
// ── Lista de códigos ──────────────────────────────────────────────────────────
// Los 14 que vinieron por código. Agrega aquí los que resuelva el PASO 1
// (scripts/ubicar_colegiados_lista_4.sql) para los 9 que vinieron por nombre.

const CODIGOS = [
  31055, 33446, 21678, 14840, 36520, 23143, 15486, 10717,
  34103, 14523, 45579, 44287, 30362, 47902,
  // ── pendientes de completar con el PASO 1 ──
  // yris Brito, Wendy Reyes, Glory Pacheco, Anastacia Portes,
  // Annalies Valerio, Ani Diaz, Madeline Pérez, Ruselis Cabral, Yanelys Figueroa
]
...
console.log('\nSiguiente: corre scripts/reporte_lista_4.sql en el SQL Editor y exporta CSV.')
