 ...
 * dirigente Silvio García (ya cargados en el sistema) y guarda monto_deuda.
 *
 * Flujo (un solo comando):
 *   1) RPC get_pares_por_dirigente('silvio garcia') → codigo,cedula desde padron.
 ...
 *
 * Uso:
 *   node scripts/consultar_deuda_silvio_garcia.mjs
 *
...
const DIRIGENTE = 'silvio garcia'   // match parcial contra padron.confirmado_por
