/**
 * Consulta la deuda REAL en codiaenlinea.com para un segundo listado de códigos
 ...
 *
 * Uso:
 *   node scripts/consultar_deuda_lista_2.mjs
 *
...
// ── Lista de códigos (sin duplicados) ─────────────────────────────────────────

const CODIGOS = [
  45629, 24434, 35208, 18153, 41205, 48008, 21143,
  29118, 41030, 16343, 32025, 40534, 33950,
]
