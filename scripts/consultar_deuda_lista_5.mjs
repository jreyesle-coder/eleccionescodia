/**
 * PASO 2 — Consulta la deuda REAL en codiaenlinea.com para la lista 5
 ...
 *   node scripts/consultar_deuda_lista_5.mjs
 *
...
// ── Lista de códigos ──────────────────────────────────────────────────────────
// Los 17 códigos únicos que vinieron por código (la lista original traía
// 32799, 32790, 32791, 29983, 27461 y 39874 repetidos). Agrega aquí los que
// resuelva el PASO 1 (scripts/ubicar_colegiados_lista_5.sql) para los 2
// que vinieron por nombre.
...
const CODIGOS = [
  ...
  // Acenet Rodríguez, Ramona Rodríguez
]
...
console.log('\nSiguiente: corre scripts/reporte_lista_5.sql en el SQL Editor y exporta CSV.')
